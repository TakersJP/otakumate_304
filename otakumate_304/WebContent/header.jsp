...
<body>
    <header>
        ...
        <div class="header-container">
            <div class="header-h1">
                <h1 align="center"><font face="cursive" color="#3399FF"><a href="index.jsp">Otakumate</a></font></h1>
            </div>
            <div class="header-h3">
                <h3 align="center"><font face="cursive" color="#3399FF"><a href="index.jsp">~Anime Store~</a></font></h3>
            </div>
        </div>
        <nav>
