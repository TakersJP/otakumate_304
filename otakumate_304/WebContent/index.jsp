...
<html>
<head>
<title>Otakumate Main Page</title>
<link href="css/bootstrap.min.css" rel="stylesheet">
	<style>
        body {
			...
			background-image: url('img/store_title.jpg'); /* Set the path to your background image */
...
<body>
<%-- <h1 align=center><font face=cursive color=#3399FF>Otakumate</font></h1> --%>
<%-- <h1 align="center">Welcome to Otakumate!</h1> --%>
